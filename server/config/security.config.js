// ============================================================
//  server/config/security.config.js — Enterprise Grade
// ============================================================
...
module.exports = {
  ...
  rateLimit: {
    ...
    global:  { windowMs: 60000,       max: parseInt(process.env.RL_GLOBAL_MAX  || '150') },
    api:     { windowMs: 15 * 60000,  max: parseInt(process.env.RL_API_MAX     || '200') },
  ...
  botDetection: {
    ...
    anomalyRpmThreshold:  parseInt(process.env.ANOMALY_RPM || '200'),
  ...
  ipBlocking: {
    ...
    banThreshold:   parseInt(process.env.IP_BAN_THRESHOLD    || '30'),
    banDurationMs:  parseInt(process.env.IP_BAN_DURATION_MS  || String(60 * 60000)),
  ...
  connectionProtection: {
    ...
    maxConnPerIp:     parseInt(process.env.MAX_CONN_PER_IP     || '30'),
    maxBodySizeBytes: parseInt(process.env.MAX_BODY_SIZE_BYTES || String(10 * 1024 * 1024)),
  },

  slowRequest: {
    enabled:          bool(process.env.SLOW_REQUEST_ENABLED, true),
    requestTimeoutMs: parseInt(process.env.REQUEST_TIMEOUT_MS || '20000'),
  },
  ...
  logging: {
    ...
    alertCooldownMs: parseInt(process.env.ALERT_COOLDOWN_MS || '60000'),
