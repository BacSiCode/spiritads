...
// ══════════════════════════════════════════════════════════════
//  1. TRUST PROXY — phải set trước mọi thứ
//     Render đứng sau load balancer → cần trust proxy = 1
//     để lấy IP thật của user từ X-Forwarded-For
//     Nếu không set → mọi request đều ra ::1 (localhost) → lỗ hổng!
// ══════════════════════════════════════════════════════════════
app.set('trust proxy', 1);

// ══════════════════════════════════════════════════════════════
//  2. ANTI-DDOS — đặt SỚM NHẤT
